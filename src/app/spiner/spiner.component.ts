...
export class SpinerComponent implements OnInit {
  ...
  wantToStopSpecificPosition:boolean = true;
  ...
  constructor(private dataService:DataService) {
    ...
    this.spinWheelObjectArray =  this.dataService.spinData.numberOfspinAdd;
    ...
    for(let data of this.spinWheelObjectArray){ 
      this.sectors.push({ 'color':data.bgColor, 'label': data.name , 'check' : true , 'id':data.id}); 
    }
